...
public class SettinsActivity extends AppCompatActivity {
    ...
    private TextView profileChangeTextBtn, closeTextBtn, saveTextButuon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveTextButuon= (TextView) findViewById(R.id.update_account_settings_btn);
        ...
        saveTextButuon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//quand l'utilisateur va cliquer sur ce boutton l'utilisateur pourra changer son image de profile
    ...
    private void uploadImage() {
        ...
        if(imageUri != null){
            ...
            Toast.makeText(SettinsActivity.this, "Images that not selected...", Toast.LENGTH_SHORT).show();
        }
