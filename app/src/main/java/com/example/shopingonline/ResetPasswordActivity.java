...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if(check.equals("settings")){
            ...
            titleQuestions.setText("Answer These Security Questions Please?");

            verifyBtn.setText("Set");

            displayePreviousAnswers();
    ...
    private void displayePreviousAnswers(){
                                                    ...
                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            ...
                                                            if(task.isSuccessful()){
                                                                ...
                                                                Toast.makeText(ResetPasswordActivity.this, "Password changed successflly", Toast.LENGTH_SHORT).show();
